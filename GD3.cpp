...
#define VERBOSE             0
#include "GD3.h"
#define POR_PIN             7   // Definir el pin PD de las pantallas http://hotmcu.com by lightcalamar
...
#define ORIENTACION         0   //0, 1, 2, 3, establece la orientación de pantalla de error/calibración
...
if (ORIENTACION == 0){
  GD.Begin(BITMAPS);
  ColorRGB(255,255,0);  GD.Vertex2ii(350, 85, 0, 0);
  ColorRGB(255,255,255);  

#if (FT_810_ENABLE==1)
// Serial.println("FT810");
 cmd_text(GD.w / 2, (GD.h / 2)+(2*(GD.h / 17)), 27, OPT_CENTERX, "FT810 en  linea");
#endif

#if (FT_811_ENABLE==1)
// Serial.println("FT811");
 cmd_text(GD.w / 2, (GD.h / 2)+(2*(GD.h / 17)), 27, OPT_CENTERX, "FT811 en  linea");
#endif

#if (FT_812_ENABLE==1)
// Serial.println("FT812");
 cmd_text(GD.w / 2, (GD.h / 2)+(2*(GD.h / 17)), 27, OPT_CENTERX, "FT812 en linea");
#endif

#if (FT_813_ENABLE==1)
 //Serial.println("FT813");
 cmd_text(GD.w / 2, (GD.h / 2)+(2*(GD.h / 17)), 27, OPT_CENTERX, "FT813 en linea");
#endif

#if (MCU_Teensy3X==0)
 cmd_text(GD.w / 2, (GD.h / 2)+(3*(GD.h / 17)), 27, OPT_CENTERX, "MCU: Arduino");
#endif

#if (MCU_Teensy3X==2)
 cmd_text(GD.w / 2, (GD.h / 2)+(3*(GD.h / 17)), 27, OPT_CENTERX, "MCU: Teensy 3.2");
#endif

#if (MCU_Teensy3X==6)
 cmd_text(GD.w / 2, (GD.h / 2)+(3*(GD.h / 17)), 27, OPT_CENTERX, "MCU: Teensy 3.6");
#endif
  
ColorRGB(255,0,0);

  cmd_text(GD.w / 2, GD.h / 2, 30, OPT_CENTERX, "Toca el punto para calibrar la pantalla touch");
  //cmd_number((GD.w / 2)-(GD.w / 13), (GD.h / 2)+(GD.h / 20), 30, 0, GD.w);
  //cmd_text(GD.w / 2, (GD.h / 2)+(GD.h / 20), 30, OPT_CENTERX, "x");
  //cmd_number((GD.w / 2)+(GD.w / 78), (GD.h / 2)+(GD.h / 20), 30, 0, GD.h);
}
...
if (ORIENTACION == 2){
  GD.Begin(BITMAPS);
  ColorRGB(255,255,0);  GD.Vertex2ii(200, 200, 0, 0);
  ColorRGB(255,255,255);  

#if (FT_810_ENABLE==1)
// Serial.println("FT810");
 cmd_text(GD.h / 2, (GD.h / 2)+(2*(GD.h / 17)), 27, OPT_CENTERX, "FT810 en  linea");
#endif

#if (FT_811_ENABLE==1)
// Serial.println("FT811");
 cmd_text(GD.h / 2, (GD.w / 2)+(2*(GD.h / 17)), 27, OPT_CENTERX, "FT811 en  linea");
#endif

#if (FT_812_ENABLE==1)
// Serial.println("FT812");
 cmd_text(GD.h / 2, (GD.w / 2)+(2*(GD.h / 17)), 27, OPT_CENTERX, "FT812 en linea");
#endif

#if (FT_813_ENABLE==1)
 //Serial.println("FT813");
 cmd_text(GD.h / 2, (GD.w / 2)+(2*(GD.h / 17)), 27, OPT_CENTERX, "FT813 en linea");
#endif

#if (MCU_Teensy3X==0)
 cmd_text(GD.h / 2, (GD.w / 2)+(3*(GD.h / 17)), 27, OPT_CENTERX, "MCU: Arduino");
#endif

#if (MCU_Teensy3X==2)
 cmd_text(GD.h / 2, (GD.w / 2)+(3*(GD.h / 17)), 27, OPT_CENTERX, "MCU: Teensy 3.2");
#endif

#if (MCU_Teensy3X==6)
 cmd_text(GD.h / 2, (GD.w / 2)+(3*(GD.h / 17)), 27, OPT_CENTERX, "MCU: Teensy 3.6");
#endif
  
ColorRGB(255,0,0);

  cmd_text(GD.h / 2, GD.w / 2, 29, OPT_CENTERX, "Toca el punto para calibrar la pantalla touch");
  //cmd_number((GD.h / 2)-(GD.h / 13), (GD.w / 2)+(GD.w / 20), 29, 0, GD.w);
  //cmd_text(GD.h / 2, (GD.h / 2)+(GD.w / 20), 29, OPT_CENTERX, "x");
  //cmd_number((GD.h / 2)+(GD.h / 78), (GD.w / 2)+(GD.w / 20), 29, 0, GD.h);
}
...
if (ORIENTACION == 2){
   GD.Begin(BITMAPS);
   GD.Vertex2ii((GD.h / 2)-100, 0, 0);
   ColorRGB(255,255,0);
   cmd_text(240, (GD.h / 2) - (GD.h / 20), 30, OPT_CENTERX, "ERROR");
   cmd_text(240, (GD.h / 2) + (GD.h / 20), 30, OPT_CENTERX, "Revisar comandos");
   cmd_text(GD.h / 2, (GD.h / 2) + 3*(GD.h / 20), 28, OPT_CENTERX, "- Falta GD.Swap");
   cmd_text(GD.h / 2, (GD.h / 2) + 4*(GD.h / 20), 28, OPT_CENTERX, "- Revisar nombre de archivo png o jpg");
   cmd_text(GD.h / 2, (GD.h / 2) + 5*(GD.h / 20), 28, OPT_CENTERX, "- Grabar archivo png o jpg en la tarjeta microSD");
   cmd_text(GD.h / 2, (GD.h / 2) + 6*(GD.h / 20), 28, OPT_CENTERX, "- Revisar sintaxis de instrucciones");
  }
